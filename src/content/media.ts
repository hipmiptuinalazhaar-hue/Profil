...
export const brandAssets: MediaAsset[] = [
  { id: "brand-hipmi-pt", label: "Logo HIPMI PT UIN Al Azhaar", sourceFile: "file_000000002e6c81f89988bcb9de62f4b1.png", publicPath: "/assets/brand/hipmi-pt-uin-alazhaar.avif", width: 1536, height: 1536, context: "brand", alt: "Logo HIPMI PT UIN Al Azhaar Lubuklinggau", status: "production" },
...
export const documentaryAssets: MediaAsset[] = [
  ...
  { id: "pelantikan-6003", label: "Pelantikan Akbar — serah terima dokumen", sourceFile: "IMG_6003.JPG", width: 1536, height: 1024, context: "pelantikan", alt: "Serah terima dokumen pada Pelantikan Akbar HIPMI PT Kampus se-Linggau Raya 2026", status: "mastered" },
  ...
  { id: "pelantikan-nmsa9653", label: "Bazar UMKM — interaksi booth", sourceFile: "NMSA9653.JPG", width: 1536, height: 1024, context: "pelantikan", alt: "Interaksi pada booth Bazar UMKM dalam rangkaian Pelantikan Akbar HIPMI PT Kampus se-Linggau Raya 2026", status: "mastered" },
